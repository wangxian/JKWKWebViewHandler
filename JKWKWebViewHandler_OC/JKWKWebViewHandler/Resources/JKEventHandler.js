...
var JKBridgeEvent = {
  ...
  removeEvent: function (callBackID) {
      let callBackIDPrefix = callBackID.substr(0, callBackID.length - 15);
      delete this._listeners[callBackIDPrefix + "successCallBack"];
      delete this._listeners[callBackIDPrefix + "failureCallBack"];
      return this;
  }
}
